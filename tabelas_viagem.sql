...
CREATE TABLE ESTABELECIMENTO_COMERCIAL (
   ...
   CONSTRAINT CK_AVALIACAO_ESTAB CHECK(AVALIACAO BETWEEN 0 AND 5),
...
CREATE TABLE BARRACA(
    ...
    CONSTRAINT FK_FEIRA FOREIGN KEY(CNPJ) REFERENCES FEIRA(CNPJ) ON DELETE CASCADE
);
...
CREATE TABLE RESTAURANTE(
    ...
    CONSTRAINT CK_CLASSE CHECK (CLASSE BETWEEN 'A' AND 'D')
);
...
CREATE TABLE AVALIAR(
    ...
    CONSTRAINT CK_AVALIACAO_AVALIAR CHECK(AVALIACAO BETWEEN 0 AND 5)
);
