...
-- AVALIACOES, EMBORA SEJA UM ATRIBUTO DERIVADO, NÃO É TRATADO COMO TAL E NÃO H�? LIMITAÇÃO PARA O VALOR NO "AVALIA"
...
INSERT INTO PAIS (NOME, DESC_GAST) VALUES ('CANADA', 'CONHECIDO POR PEIXES E MASSAS');
INSERT INTO PAIS (NOME, DESC_GAST) VALUES ('FRANCA', 'PAIS DO PERFUME');
-- VIOLANDO UMA PK
...
INSERT INTO CIDADE (NOME_CIDADE, NOME_ESTADO, NOME_PAIS, DESC_GAST) VALUES ('VANCOUVER','COLUMBIA BRITANICA','CANADA',NULL);
INSERT INTO CIDADE (NOME_CIDADE, NOME_ESTADO, NOME_PAIS, DESC_GAST) VALUES ('PARIS','ILE FRANCE','FRANCA',NULL);
INSERT INTO CIDADE (NOME_CIDADE, NOME_ESTADO, NOME_PAIS, DESC_GAST) VALUES ('NOVA YORK','NOVA YORK','ESTADOS UNIDOS',NULL);
...
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.555/0001-03','VANCOUVER','COLUMBIA BRITANICA','BREADS',NULL,NULL,'08:00','18:00',NULL,NULL,NULL,NULL,5,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-09','PARIS','ILE FRANCE','PARRI',NULL,NULL,'08:00','18:00',NULL,NULL,NULL,NULL,5,'HOTEL');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-10','PARIS','ILE FRANCE','PARRIMOBIE',NULL,NULL,'08:00','18:00',NULL,NULL,NULL,NULL,5,'HOTEL');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-11','PARIS','ILE FRANCE','PATISSERRIE',NULL,NULL,'08:00','18:00',NULL,NULL,NULL,NULL,5,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-12','PARIS','ILE FRANCE','POTOCA',NULL,NULL,'08:00','18:00',NULL,NULL,NULL,NULL,5,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-13','NOVA YORK','NOVA YORK','TRANSILV�NIA',NULL,NULL,'08:00','18:00','BROOKLYN',NULL,NULL,NULL,3,'HOTEL');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-14','SAO PAULO','SAO PAULO','LAMENS',NULL,NULL,'08:00','18:00','BROOKLYN',NULL,NULL,NULL,3,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-15','NOVA YORK','NOVA YORK','EAT FOOD',NULL,NULL,'08:00','18:00','BROOKLYN',NULL,NULL,NULL,4,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-16','NOVA YORK','NOVA YORK','YOUR CHRISTMAS',NULL,NULL,'08:00','18:00','BROOKLYN',NULL,NULL,NULL,4.2,'PONTO');
INSERT INTO ESTABELECIMENTO_COMERCIAL(CNPJ,NOME_CIDADE,NOME_ESTADO,NOME,TELEFONE,SITE,HORARIO_INICIO,HORARIO_FIM,RUA,BAIRRO,CEP,NUMERO,AVALIACAO,TIPO) VALUES ('11.222.888/0001-17','NOVA YORK','NOVA YORK','NAVIDAD',NULL,NULL,'08:00','18:00','BROOKLYN',NULL,NULL,NULL,4.4,'PONTO');
-- VIOLANDO OS CHECKS:
-- CNPJ
...
INSERT INTO TAGS (CNPJ, TAG) VALUES ('11.222.888/0001-16','COMIDA NATALINA');
INSERT INTO TAGS (CNPJ, TAG) VALUES ('11.222.888/0001-17','COMIDA NATALINA');
INSERT INTO TAGS (CNPJ, TAG) VALUES ('11.222.888/0001-14','COMIDA NATALINA');
...
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.555/0001-03','PAO SEM GLUTEN');
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.555/0001-03','VEGANO');
...
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.888/0001-15','VEGETARIANO');
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.888/0001-16','VEGETARIANO');
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.888/0001-17','VEGETARIANO');
INSERT INTO RESTRICOES_ALIMENTARES (CNPJ, RESTRICAO) VALUES ('11.222.888/0001-14','VEGETARIANO');
...
INSERT INTO BARRACA (CNPJ,NOME_BARRACA,TIPO_COMIDA) VALUES ('11.222.333/0001-01','FRANGO GIRANDO','FRANGO ASSADO');
INSERT INTO BARRACA (CNPJ,NOME_BARRACA,TIPO_COMIDA) VALUES ('11.222.333/0001-01','FRANGO FRITANDO','PASTEL DE FRANGO');
INSERT INTO BARRACA (CNPJ,NOME_BARRACA,TIPO_COMIDA) VALUES ('11.222.333/0001-01','FRANGO FRITANDO2','FRANGO FRITO');
-- VIOLANDO CHAVE COMPOSTA 
...
INSERT INTO RESTAURANTE (CNPJ_RES,CARDAPIO,CLASSE) VALUES ('11.222.888/0001-11','PAO','A');
INSERT INTO RESTAURANTE (CNPJ_RES,CARDAPIO,CLASSE) VALUES ('11.222.888/0001-12','PAO','A');
...
INSERT INTO QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, PRECO, TIPO_QUARTO, CAPACIDADE) VALUES ('11.222.888/0001-09',12,250,'FAMILIA',4);
INSERT INTO QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, PRECO, TIPO_QUARTO, CAPACIDADE) VALUES ('11.222.888/0001-09',10,100,'SOLTEIRO',1);
INSERT INTO QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, PRECO, TIPO_QUARTO, CAPACIDADE) VALUES ('11.222.888/0001-09',11,200,'CASAL',2);
INSERT INTO QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, PRECO, TIPO_QUARTO, CAPACIDADE) VALUES ('11.222.888/0001-10',01,200,'UNICO',2);
...
INSERT INTO DISPONIBILIDADE_QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, DATA_INDISPONIVEL) VALUES ('11.222.888/0001-09',11,'13/04/2022');
INSERT INTO DISPONIBILIDADE_QUARTO (CNPJ_HOTEL,NUMERO_QUARTO, DATA_INDISPONIVEL) VALUES ('11.222.888/0001-10',01,'12/04/2022');
...
INSERT INTO RESTAURANTE_DE_HOTEL (CNPJ_HOTEL,CNPJ_RES) VALUES ('11.222.888/0001-09','11.222.888/0001-11');
INSERT INTO RESTAURANTE_DE_HOTEL (CNPJ_HOTEL,CNPJ_RES) VALUES ('11.222.888/0001-10','11.222.888/0001-11');
INSERT INTO RESTAURANTE_DE_HOTEL (CNPJ_HOTEL,CNPJ_RES) VALUES ('11.222.888/0001-09','11.222.888/0001-12');
...
INSERT INTO RESTRICOES_TURISTA (CPF, RESTRICAO) VALUES ('111.222.333-43','PAO SEM GLUTEN');
INSERT INTO RESTRICOES_TURISTA (CPF, RESTRICAO) VALUES ('111.222.333-43','VEGANO');
