...
export default {
  ...
  methods: {
    async adicionar(id) {
      const response = await this.$axios.post(`/api/pedido/1/111.222.333-42/adicionar/passagem/${encodeURIComponent(id)}`)
